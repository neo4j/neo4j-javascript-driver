...
import BoltProtocolV6x1 from '../../src/bolt/bolt-protocol-v6x1'
...
describe('#unit BoltProtocolV6x1', () => {
  beforeEach(() => {
  ...
  it('should enrich error metadata', () => {
    const protocol = new BoltProtocolV6x1()
  ...
  it('should request routing information', () => {
    ...
    const protocol = new BoltProtocolV6x1(recorder, null, false)
  ...
  it('should return correct bolt version number', () => {
    const protocol = new BoltProtocolV6x1(null, null, false)

    expect(protocol.version).toEqual(new ProtocolVersion(6, 1))
  })
  ...
  it('should initialize connection', () => {
    ...
    const boltAgent = {
      product: 'neo4j-javascript/6.1',
      platform: 'netbsd 1.1.1; Some arch',
      languageDetails: 'Node/16.0.1 (v8 12.4.254.21)'
    }
  ...
  it.each([
    ...
    const boltAgent = {
      product: 'neo4j-javascript/6.1',
      platform: 'netbsd 1.1.1; Some arch',
      languageDetails: 'Node/22.22.3 (v8 12.4.254.21)'
    }
    const authToken = { username: 'neo4j', password: 'secret' }
  ...
  describe('unpacker configuration', () => {
    test.each([
      ...
      (disableLosslessIntegers, useBigInt) => {
        const protocol = new BoltProtocolV6x1(null, null, {
  ...
  describe('watermarks', () => {
    it('.run() should configure watermarks', () => {
      ...
      const protocol = utils.spyProtocolWrite(
        new BoltProtocolV6x1(recorder, null, false)
      )
  ...
  describe('.unpack()', () => {
    ...
    ])('should unpack uuids: (%s)', (_, struct, object) => {
      const buffer = alloc(256)
      const protocol = new BoltProtocolV6x1(
        new utils.MessageRecordingConnection(),
        buffer,
  ...
  describe('result metadata enrichment', () => {
    it('run should configure BoltProtocolV6x1._enrichMetadata as enrichMetadata', () => {
      const database = 'testdb'
      const bookmarks = new Bookmarks([
        'neo4j:bookmark:v1:tx1',
        'neo4j:bookmark:v1:tx2'
    ...
    describe('BoltProtocolV6x1._enrichMetadata', () => {
  ...
  function newProtocol (recorder) {
    return new BoltProtocolV6x1(recorder, null, false, undefined, undefined, () => {})
  }
})
