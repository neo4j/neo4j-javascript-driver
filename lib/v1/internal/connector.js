  ...
  (0, _createClass3.default)(ConnectionState, [{
    ...
    value: function wrap(observer) {
      ...
      return {
        ...
        onError: function onError(error) {
          _this10._initializationError = error;
          if (_this10._rejectPromise) {
        ...
        onCompleted: function onCompleted(metaData) {
          if (metaData && metaData.server) {
            _this10._connection.setServerVersion(metaData.server);
          }
          _this10._initialized = true;
          if (_this10._resolvePromise) {
            _this10._resolvePromise(_this10._connection);
            _this10._resolvePromise = null;
          }
    ...
    value: function initializationCompleted() {
      ...
      if (this._initialized) {
        return _promise2.default.resolve(this._connection);
      } else if (this._initializationError) {
        return _promise2.default.reject(this._initializationError);
      } else {
        return new _promise2.default(function (resolve, reject) {
          _this11._resolvePromise = resolve;
          _this11._rejectPromise = reject;
        });
      }
    }
  }]);
...
function connect(url) {
  ...
  var host = (0, _util.parseHost)(url);
  var port = (0, _util.parsePort)(url) || 7687;
