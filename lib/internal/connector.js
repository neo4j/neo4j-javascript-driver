...
Connection.prototype.initialize = function( clientName, onSuccess ) {
...
Connection.prototype.run = function( statement, params, onSuccess ) {
  this._regCallback( null, onSuccess );
...
Connection.prototype.pullAll = function( onRecord, onSuccess ) {
...
Connection.prototype.discardAll = function( onSuccess ) {
  this._regCallback( null, onSuccess );
...
Connection.prototype.ackFailure = function( onSuccess ) {
  this._regCallback( null, onSuccess );
...
Connection.prototype._regCallback = function( onRecord, onSuccess ) {
  var id = this._outboundExchangeId;
...
Connection.prototype._handleIncomingMessage = function( msg ) {
