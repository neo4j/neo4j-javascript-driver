...
function Connector(channel) {
    ...
    this._requestId = 0;
    this._ch = channel;
    this._chunker = null // TODO new Chunker( channel )
    this._out = null; // TODO new Packer( chunker );
...
Connector.prototype.run = function( statement, params, cb ) {
  this._regCallback( cb );
...
Connector.prototype.pullAll = function( cb ) {
  this._regCallback( cb );
...
Connector.prototype.discardAll = function( cb ) {
  this._regCallback( cb );
...
Connector.prototype.ackFailure = function( cb ) {
  this._regCallback( cb );
...
Connector.prototype._regCallback = function( cb ) {
...
Connector.prototype.sync = function() {
  console.log( this._outbox ); // TODO this._chunker.flush()
}
