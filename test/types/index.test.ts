...
const error2: neo4j.Neo4jError = new neo4j.Neo4jError(
  'Error message',
  'Error code'
)
...
const duration: neo4j.Duration = new neo4j.types.Duration(
  int1,
  int1,
  int1,
  int1
)
const localTime: neo4j.LocalTime = new neo4j.types.LocalTime(
  int1,
  int1,
  int1,
  int1
...
const localDateTime: neo4j.LocalDateTime = new neo4j.types.LocalDateTime(
  int1,
  int1,
  int1,
  int1,
...
const dateTime: neo4j.DateTime = new neo4j.types.DateTime(
  int1,
  int1,
  int1,
  int1,
