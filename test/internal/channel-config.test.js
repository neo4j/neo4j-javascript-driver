...
describe('ChannelConfig', () => {
  ...
  it('should validate value of "trust" property', () => {
    ...
    expect(
      new ChannelConfig(null, { trust: 'TRUST_ON_FIRST_USE' }, '').trust
    ).toEqual('TRUST_ON_FIRST_USE')
    expect(
      new ChannelConfig(null, { trust: 'TRUST_SIGNED_CERTIFICATES' }, '').trust
    ).toEqual('TRUST_SIGNED_CERTIFICATES')
    expect(
      new ChannelConfig(
        null,
